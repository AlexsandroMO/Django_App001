...
def taskList(request):
    ...
    #user_login = Trata.read_sql3()
    #print('\n\n\n')
    #rint(user_login)
    #print('{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n'.format(user_login.id, user_login.password, user_login.last_login, user_login.is_superuser, user_login.username, user_login.first_name, user_login.email, user_login.is_staff, user_login.is_active, user_login.date_joined, user_login.last_name))
    #print('\n\n\n')

    #tasktask = Trata.read_sql4()
    #print('\n\n\n')
    #print(tasktask.description)
    #print('\n\n\n')
